...
int32_t TABLE_LENGTH = 35;
/*!
nodo_position deve essere al massimo la lunghezza del vettore
major +1 , minor -1
*/
void visit(std::vector<nodo>& iNodi, uint32_t nodo_position,nodo* root){
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	nodo* winner = nullptr;
	for (int idx = 0; idx < mNodi.size(); ++idx)
	{
